...
flux_2025_rice_seasonal_emissions <- flux_2025_rice_interpolated %>%
  ...
  plot_number %in% c("105", "201", "301") ~ "No",
  plot_number %in% c("106", "206", "302") ~ "No",
  plot_number %in% c("101", "204", "306") ~ "Yes",
  ...
  plot_number %in% c("101", "204", "306") ~ "No",
  plot_number %in% c("103", "205", "304") ~ "Yes",
  plot_number %in% c("102", "203", "305") ~ "Yes",
  TRUE ~ "Other" # This line handles cases where plot is not listed
)) %>%
   mutate_if(sapply(flux_2025_rice_seasonal_emissions, is.character), as.factor)
