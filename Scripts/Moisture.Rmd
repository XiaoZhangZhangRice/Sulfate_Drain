...
```{r}
Datalogger_1 <- read_excel("../Data/z6-22118 07May26-1055_Blk1.xlsx", sheet = 1, skip = 2)
Datalogger_2 <- read_excel("../Data/z6-24135 07May26-1104_Blk3.xlsx", sheet = 1, skip = 2)
...
moisture <- moisture %>%
  filter(Timestamp >= as.POSIXct("2025-06-20") &
         Timestamp <  as.POSIXct("2025-07-03"))
...
Moisture_graph <-
  ...
  summarise(
    ...
    se_moisture = sd(Moisture, na.rm = TRUE) / sqrt(4)
  )
...
ggplot(moisture_summary,
  ...
  labs(
    title = "Soil water content during mid-season drain",
    x = "Date",
...
```{r}
sulfate_all_graphing_3trt <- sulfate_all_graphing %>% filter(Treatment != "LD-MS") %>% filter(Treatment !="CF-PP")


sulfate_over_time_3trt <- 
...
ggsave(sulfate_over_time_3trt, filename = "../Figures/sulfate_over_time_3trt.jpg", height = 25, width = 30, units = "cm", dpi=400)
